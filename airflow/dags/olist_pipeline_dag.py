...
with DAG(
    ...
    bronze_task = BashOperator(
        ...
        bash_command='spark-submit --packages org.apache.iceberg:iceberg-spark-runtime-3.3_2.12:1.4.3 /opt/airflow/processing/bronze_ingestion.py'
    )
    ...
    silver_task = BashOperator(
        ...
        bash_command='spark-submit --packages org.apache.iceberg:iceberg-spark-runtime-3.3_2.12:1.4.3 /opt/airflow/processing/silver_transformation.py'
    )
    ...
    gold_task = BashOperator(
        ...
        bash_command='spark-submit --packages org.apache.iceberg:iceberg-spark-runtime-3.3_2.12:1.4.3 /opt/airflow/processing/gold_modeling.py'
    )
